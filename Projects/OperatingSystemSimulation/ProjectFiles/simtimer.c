...
void *runTimer( void *inputVal )
   {
    int milliSeconds = *(int *)inputVal;
...
void *accessTimer( void *inputArgs )
   {
    int controlCode = ( (TimerArgs *)inputArgs )->flag;
    char *timeStr = ( (TimerArgs *)inputArgs )->str;
